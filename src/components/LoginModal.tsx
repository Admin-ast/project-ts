              ...
              >
                {step === 1 ? (
                  <Dialog.Panel className="w-full max-w-sm transform space-y-6 overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all lg:max-w-lg">
                    <Dialog.Title
                      as="h3"
                      className="text-dark  relative bg-[#DC6563] py-4 text-lg font-medium leading-6"
                    >
                      <p className="text-center text-white">
                        Continue with Phone
                      </p>
                  ...
                  <Dialog.Panel className="w-full max-w-sm transform space-y-6 overflow-hidden rounded-2xl bg-white text-left align-middle shadow-xl transition-all lg:max-w-lg">
                    <Dialog.Title
                      as="h3"
                      className="text-dark relative  bg-[#DC6563] py-2 text-lg font-medium leading-6"
                    >
                      <p className="text-center text-white">Verify Phone</p>
                      <div className="absolute left-4 top-2">
                        <ArrowLeftIcon
                    ...
                    <div className="space-y-6 p-4 lg:px-12 lg:pb-12">
                      ...
                      <div className="space-y-2">
                        ...
                        <Button
                          onClick={handleSubmitOtp}
                          className="text-dark mx-auto w-full rounded-lg bg-gradient-to-b from-[#FF7646] to-[#FF0600] py-2 text-lg font-bold"
                          btnText="Login"
                        />
                      </div>
                    </div>
