...
const TrendingVideosCard = (props: Props) => {
  return (
    <div className="rounded-[15px] border-b-[7px] border-b-[#DC6563] ">
      <Link href="/astrologeradmin/trendingvideos">
        <div className="  cursor-pointer p-10 shadow-xl">
          <div className="m-auto h-[82px] w-[82px] rounded-[100%] bg-[#f4af91] py-4">
            <img
              src="/assets/admin/settings/video.svg"
              alt="Card Image"
