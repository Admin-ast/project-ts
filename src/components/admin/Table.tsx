    ...
    <div className="">
      <Section>
        <table className="mt-[35px] w-full border-collapse ">
          <thead>
            <tr>
              <th className="border-b bg-gray-100 py-2 px-4 lg:text-2xl">
                Type
              </th>
              <th className="border-b bg-gray-100 py-2 px-4 lg:text-2xl">
                Your Price
          ...
          {/* Add table body (tbody) and rows (tr) here */}
          ...
          <tbody>
            <tr>
              ...
              <td className=" border-b ">
                <button className="bg-[#D9D9D9] px-[25px] text-lg text-white md:px-[100px] lg:px-[100px] lg:py-[14px]">
                  N/A
                </button>
              </td>
            </tr>
            <tr>
              <td className="border-b py-2 px-4 lg:text-xl">Report</td>
              <td className="border-b  py-2 lg:px-40 lg:text-xl">
                (0.0/query)
              </td>
              <td className="border-b py-2 px-8 lg:px-60 lg:text-xl">
                <BsToggleOn className="text-[20px] text-[#CF2927]" />
