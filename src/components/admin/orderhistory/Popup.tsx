...
const Popup: React.FC<PopupProps> = ({ onClose }) => {
  ...
  return (
    <div className="fixed inset-0 flex h-screen items-center justify-center bg-gray-800 bg-opacity-50">
      <div className="relative rounded-md bg-white p-8">
        ...
        <p className="text-left">Remedy Type</p>
        <div className="mt-2 flex justify-between ">
          <button className=" rounded-md bg-[#D9D9D9] px-8 py-2 text-white hover:bg-green-600 focus:border-green-300 focus:outline-none focus:ring">
            Paid Remedy
          </button>
          <button className=" rounded-md bg-[#00AF1C] px-8 py-2 text-white hover:bg-green-600 focus:border-green-300 focus:outline-none focus:ring">
            Free Remedy
          </button>
        </div>
